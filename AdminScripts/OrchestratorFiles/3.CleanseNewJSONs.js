...
const folderPath = path.join(__dirname, "../Outputs/item"); // Replace with the actual path to your folder
const gemstonesFolderPath = path.join(__dirname, "../Outputs/gemstones");
